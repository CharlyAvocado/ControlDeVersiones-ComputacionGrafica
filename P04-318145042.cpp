...
int main()
{
	...
	CrearCilindro(20, 1.5f);//índice 2 en MeshList
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.256, 0.256f, 0.256f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//cuello
		model = modelaux;
		model = glm::translate(model, glm::vec3(-5.5f, 2.0f, 0.0f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(1.25f, 6.0f, 1.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::scale(model, glm::vec3(3.5f, 4.5f,4.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();
		model = modelaux;
		//hocico, nariz y lengua
		model = glm::translate(model, glm::vec3(-9.0f, 2.5f, 0.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(2.25f, 1.0f, 1.75f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.512f, 0.512f, 0.512f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		model = modelaux;
		...
		model = glm::scale(model, glm::vec3(2.25f, 1.0f, 1.75f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.753f, 0.796f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		model = modelaux;

		model = glm::translate(model, glm::vec3(-9.5f, 2.5f, 0.0f));
		...
		//ojos
		model = glm::translate(model, glm::vec3(-9.0f, 3.0f, 1.25f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux; 
		//orejas
		model = glm::translate(model, glm::vec3(-7.0f, 3.75f, -2.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion19()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(1.0f, 2.5f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();
		model = modelaux;
