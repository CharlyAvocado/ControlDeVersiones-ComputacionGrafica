...
public:
	...
	bool getLamp() { return lamp; };
	bool getLamp2() { return lamp2; };
	bool getFw() { return fw; };
	bool getBw() { return bw; };
	bool getArranque() { return arranque; };
	bool getArranque2() { return arranque2; };

	bool getcaida() { return caida; }
	bool getTirada() { return tirada; };

	bool getFuego() { return fuego; };
	bool getHielo() { return hielo; };
	bool getGas() { return gas; };
	bool getArena() { return arena; }
	bool getTrueno() { return trueno; };
...
private: 
	...
	GLfloat articulacion11, articulacion12, articulacion13, articulacion14, articulacion15, articulacion16, articulacion17, articulacion18, articulacion19, articulacion20;
	GLfloat traslacion;
	bool keys[1024];
